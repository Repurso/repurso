...
export const metadata: Metadata = {
  title:
    "AI TikTok Hook Generator | Create Viral Hooks Instantly | Repurso",
  description:
    "Generate viral TikTok hooks with AI. Create attention-grabbing hooks for TikTok videos instantly with Repurso.",
  keywords: [
    ...
    "TikTok video hooks",
    "short form hooks",
    "AI social media hooks",
  ],
  openGraph: {
    title: "AI TikTok Hook Generator | Repurso",
    description:
      "Generate viral TikTok hooks instantly with AI.",
    url: "https://repurso.app/tiktok-hook-generator",
    siteName: "Repurso",
    type: "website",
  },
};
...
const hooks = [
  "Nobody tells creators this about TikTok growth.",
  "This simple hook doubled my watch time.",
  "The reason your TikToks flop is simple.",
  "I tested viral TikTok hooks for 30 days.",
  "Stop posting before fixing this mistake.",
  "This AI tool creates hooks instantly.",
];

const faqs = [
  {
    question: "What is an AI TikTok Hook Generator?",
    answer:
      "An AI TikTok Hook Generator helps creators generate scroll-stopping hooks for TikTok videos instantly.",
  },
  {
    question: "Can Repurso create viral TikTok hooks?",
    answer:
      "Yes. Repurso helps generate hooks optimized for short-form engagement and retention.",
  },
  {
    question: "Does Repurso support other platforms?",
    answer:
      "Yes. Repurso supports Instagram, LinkedIn, YouTube, X/Twitter and more.",
  },
  {
    question: "Is Repurso free?",
    answer:
      "Yes. You can generate TikTok hooks for free and upgrade later for premium features.",
  },
];
        ...
        <section className="mb-14 rounded-[32px] border border-purple-400/20 bg-gradient-to-br from-purple-950/30 via-zinc-950 to-black p-6 shadow-2xl shadow-purple-950/20 sm:p-10">
          <div className="max-w-4xl">
            ...
            <p className="mt-6 max-w-2xl text-base leading-8 text-zinc-300 sm:text-xl">
              Generate viral TikTok hooks and attention-grabbing openers
              instantly with AI.
            </p>
        ...
        <section className="mb-14 grid gap-5 md:grid-cols-3">
          <div className="rounded-3xl border border-white/10 bg-zinc-950/70 p-6">
            ...
            <p className="leading-7 text-zinc-400">
              Add your niche, content idea or audience.
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-white/10 bg-zinc-950/70 p-6">
            ...
            <p className="leading-7 text-zinc-400">
              Repurso instantly creates engaging TikTok hooks.
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-white/10 bg-zinc-950/70 p-6">
            ...
            <p className="leading-7 text-zinc-400">
              Create higher-performing short-form content instantly.
            </p>
          </div>
        </section>
